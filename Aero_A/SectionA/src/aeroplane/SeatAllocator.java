...
public class SeatAllocator {
  ...
  private void allocateInRange(Passenger passenger,
    ...
    Seat seat = first;
    if (!allocation.containsKey(seat)) {
      if (first.isEmergencyExit()) {
  ...
  private void allocateCrew(BufferedReader br)
    ...
    Crew_Members crew = new Crew_Members(firstName, lastName);
  ...
  private void allocateBusiness(BufferedReader br)
    ...
    Business_Passengers bsPassenger = new Business_Passengers(firstName, lastName, age, luxury);
    allocateInRange(bsPassenger, new Seat(1, 'A'), new Seat(1, 'F'));
    // TODO: Section A, Task 4
  ...
  private void allocateEconomy(BufferedReader br)
    ...
    String lastName = readStringValue(br);
    int age = readIntValue(br);
    Economy_Passengers econPassenger = new Economy_Passengers(firstName, lastName, age);
    allocateInRange(econPassenger, new Seat(1, 'A'), new Seat(1, 'F'));
